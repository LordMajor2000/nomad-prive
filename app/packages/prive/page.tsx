    ...
    <>
      ...
      <main style={{ background: "var(--bg-primary)", minHeight: "100vh" }}>
        ...
        <div style={{ position: "relative", height: "100vh", minHeight: "600px", overflow: "hidden" }}>
          <Image
            src="https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=1800&q=80"
          ...
          <div style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(to top, rgba(6,6,6,0.97) 0%, rgba(6,6,6,0.45) 50%, rgba(6,6,6,0.2) 100%)",
          }} />
        ...
        <section style={{ padding: "clamp(5rem, 10vw, 8rem) clamp(1.5rem, 5vw, 4rem)" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(3rem, 8vw, 7rem)", alignItems: "start" }} className="pkg-split">
            ...
            >
              ...
              {t("prive.note") && (
                <p style={{ fontSize: "0.8rem", color: "var(--muted)", fontStyle: "italic", marginBottom: "2rem", opacity: 0.7, lineHeight: 1.6 }}>
                  {t("prive.note")}
                </p>
              )}
                ...
                {includes.map((item, i) => (
                  <li
                    ...
                    style={{
                      ...
                      background: i === 0 ? "rgba(201,169,110,0.05)" : "#0d0d0d",
                      borderLeft: i === 0 ? "2px solid var(--gold-primary)" : "1px solid rgba(201,169,110,0.12)",
                    }}
                  >
                    <Check size={16} color="var(--gold-primary)" style={{ flexShrink: 0, marginTop: "2px" }} />
                    <span style={{ fontSize: "0.9rem", color: i === 0 ? "var(--gold-primary)" : "var(--cream)", opacity: 0.85, fontWeight: i === 0 ? 400 : 300, lineHeight: 1.5 }}>
                      {item}
                    </span>
                  </li>
                ))}
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2px" }} className="steps-grid">
              {steps.map((step, i) => (
                ...
                >
                  <div style={{ fontFamily: "var(--font-playfair), 'Playfair Display', serif", fontSize: "3rem", fontWeight: 700, color: "transparent", WebkitTextStroke: "1px rgba(201,169,110,0.15)", lineHeight: 1, marginBottom: "1.5rem", userSelect: "none" }}>
                    {step.num}
                  </div>
